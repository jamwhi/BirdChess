package BirdChess
{
	...
	public class Queen extends ChessPiece
	{
		...
		public function Queen(team:int)
		{
			this.team = team;
		...
		override public function highlightValidSquares(squareArray:Array, pieceArray:Array):Array
		{
			...
			if (currentSquare)
			{
				...
				// valid: combined rook and bishop valid squares
				// i just copy pasted each of their 4 while loops
				// it's a bit long, i wonder if there's a more efficient way
